...
func (game *Hokm4EngineState) BotPlayTurn(hand_cards []cards.Card) int {
...
func (game *Hokm4EngineState) _first_play(hand_cards *[]cards.Card) int {
	rand_card_index := randutils.GenerateRandomNumber(len(*hand_cards))
	return rand_card_index
}

func (game *Hokm4EngineState) _not_first_play(hand_cards *[]cards.Card) int {
	current_turn := game.CurrentTrick.CurrentTurn
...
func (game *Hokm4EngineState) WhoWinsLastTurn() *PlayerCardPlayed {
